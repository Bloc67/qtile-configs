...
function addShow() 
    ...
    if not file then
        mp.osd_message("Cannot write to media directory\n" .. "(" .. path .. ")", 2)
        return
    end
    ...
    local mallout = "a:" .. audio .. " s:" .. sub .. " p:" .. subPos ..  
        " su:" .. subScale .. " c:" .. mcontrast ..
...
mp.add_key_binding("f12", "config-save", addShow)
